...
export const metadata: Metadata = {
  ...
  description:
    "MaximumPixel is Jaipur's premier creative content, video production, 3D animation, and digital media studio founded by Krishna Rajak.",
  keywords: [
    "MaximumPixel",
    "Maximum Pixel",
    "maximumpixel",
  ...
  authors: [{ name: "Krishna Rajak" }, { name: "Krishna" }],
  creator: "Krishna Rajak",
  publisher: "MaximumPixel",
  ...
  openGraph: {
    ...
    description:
      "Transforming brands with cinematic videos, viral reels, 3D graphics, commercial photography, and branding. Founded by Krishna Rajak in Jaipur.",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
  ...
  twitter: {
    ...
    description:
      "Cinematic video production, viral social content, and brand design that convert. Founded by Krishna Rajak.",
    images: ["/og-image.jpg"],
...
export default function RootLayout({
  ...
  const organizationSchema = {
    ...
    "name": "MaximumPixel",
    "alternateName": ["Maximum Pixel", "MaximumPixel Studio", "Maximum Pixel Jaipur"],
    "url": "https://maximumpixel.online",
    "logo": "https://maximumpixel.online/assets/logo.png",
    "image": "https://maximumpixel.online/og-image.jpg",
    "description":
      "MaximumPixel is Jaipur's premier creative media agency providing video production, commercial photography, event coverage, viral reels, 3D animation, and branding design.",
    ...
    "founder": {
      ...
      "url": "https://maximumpixel.online/about",
    },
    "sameAs": [
